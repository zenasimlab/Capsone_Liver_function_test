...
On the other hand, Naive Bayes model yields relatively higher specificity (67%) than sensitivity(67%). Higher specificity indicates that there are fewer false positive results. 
